      ...
      <form onSubmit={handleSubmit} method="post" noValidate className='profile'>
        <div className='profile__conteiner'>
          ...
          <label className='profile__input-conteiner underline'>
            ...
            <input onChange={handleChange} disabled={inputDisabled} type="text" name='name' value={values.name} minLength={2} maxLength={30} required className='profile__input'></input>
          </label>
            <span className='form__error'>{errors.name}</span>
          <label className='profile__input-conteiner'>
            <span className='profile__input-title'>E-mail</span>
            <input onChange={handleChange} disabled={inputDisabled} type="email" name='email' value={values.email} required className='profile__input'></input>
          </label>
